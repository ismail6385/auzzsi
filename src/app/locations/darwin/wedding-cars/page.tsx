...
export const metadata: Metadata = {
    title: "Wedding Cars Darwin | Luxury Bridal Transport & Tropical Weddings",
    description: "Make your special day unforgettable with Darwin's premier chauffeur-driven wedding fleet. Elegant service for tropical, waterfront, and outback weddings.",
};

export default function DarwinWeddingPage() {
    const faqs = [
        {
            question: "How Far In Advance Should I Book My Wedding Cars?",
            answer: "Darwin's dry season (May to October) is peak wedding season. We recommend booking 6-12 months in advance to secure your preferred luxury vehicles for your special day."
        },
        {
        ...
        },
        {
            ...
            answer: "Yes, we generally require a minimum hire period of 3 hours for weddings in the Darwin region. This ensures there is no rushing during your photos at the waterfront, Botanic Gardens, or other scenic locations."
        },
        {
            question: "Can We View The Cars Before Booking?",
            answer: "Absolutely. We encourage you to inspect our fleet. Please contact our Darwin team to schedule a private viewing appointment."
        },
        {
    ...
    const vehicles = [
        {
            ...
            desc: 'The ultimate wedding car. Spacious, elegant, and timeless. Perfect for tropical and waterfront weddings.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            {/* HERO SECTION */}
            <Hero
                title="Luxury Wedding Cars Darwin"
                subtitle="Make your special day unforgettable with Darwin's premier chauffeur-driven wedding fleet. Elegant, timely, and picture-perfect."
                showStats={false}
            />
            ...
            <section className={styles.contentSection}>
                ...
                <div className={styles.textBlock}>
                    <p>
                        ...
                        Auzzsi Chauffeur provides impeccable wedding car services across Darwin and the Top End.
                        ...
                        to capture those perfect moments against the backdrop of Darwin's stunning waterfront, tropical gardens, or outback sunsets. We treat your day with the care it deserves.
                    </p>
            ...
            <section className={styles.contactSection}>
                ...
                <ServiceContactForm
                    ...
                    subtitle={<>
                        Tell us about your Darwin wedding and we will provide a custom package.
                        <br />
