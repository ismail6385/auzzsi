...
export default function DarwinAirportPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "How far is Darwin Airport from the city?",
            answer: "Darwin Airport (DRW) is located about 13km from the Darwin CBD. The trip typically takes 15-20 minutes."
        },
        {
            question: "Is your service available 24/7 in Darwin?",
            answer: "Yes, we operate 24 hours a day to meet all flights, including late-night and early-morning arrivals."
        }
    ];
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroContent}>
                    <div className={styles.breadcrumb}>
                        ...
                        <Link href="/locations/darwin">Darwin</Link> <span>&gt;</span>
                        Airport Transfers
                    </div>
                    <h1 className={styles.heroTitle}>Darwin Airport Transfers</h1>
                    <p className={styles.heroSubtitle}>Premium comfort in the Top End.</p>
            ...
            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Darwin Chauffeur Service</h2>
                <div className={styles.textBlock}>
                    <p>
                        Beat the heat with Auzzsi Chauffeur. Our vehicles are kept cool and comfortable for your arrival in Darwin.
                        Perfect for corporate travellers, government officials and tourists visiting the Territory.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.fleetSection}>
                <h2 className={styles.sectionTitle} style={{ textAlign: 'center' }}>Our Darwin Fleet</h2>
            ...
            <section className={styles.contactSection}>
                ...
                <div className={styles.contactFormWrapper}>
                    <h2 className={styles.helpTitle}>Contact Darwin Support</h2>
