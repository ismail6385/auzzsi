...
export default function TownsvilleHourlyPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Can we do a city tour?",
            answer: "Yes, we can take you to all the major sights including Castle Hill, The Strand, Jezzine Barracks, and the Reef HQ Aquarium."
        },
        {
            question: "Is there a minimum hire period?",
            answer: "Yes, the minimum hire period is generally 2 hours for local Townsville charters."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Tour Townsville in air-conditioned comfort.',
            passengers: 4,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Great for small groups or families.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Hourly Chauffeur Townsville"
                subtitle="Private car hire by the hour. Discover Townsville at your leisure."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Explore the Tropics</h2>
                <div className={styles.textBlock}>
                    <p>
                        Make the most of your time in North Queensland with a private chauffeur.
                        Whether you want to see the sights of Townsville city or need reliable transport
                        for a series of meetings, our hourly service offers total flexibility.
                        <br /><br />
                        Enjoy the comfort of a premium vehicle as you navigate the city.
                    </p>
                </div>
            </section>
