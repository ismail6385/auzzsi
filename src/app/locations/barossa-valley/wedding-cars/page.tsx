...
export default function BarossaWeddingPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Do you travel to Clare Valley?",
            answer: "Yes, we also service weddings in the nearby Clare Valley region."
        },
        {
            question: "Can we have photos in the vineyards?",
            answer: "Most venues allow vineyard photography. Our drivers are happy to assist in positioning the car for the perfect shot."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Timeless style for a vineyard wedding.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Spacious transport for guests and bridal parties.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Wedding Cars Barossa Valley"
                subtitle="Elegant wedding transport for your special day in wine country."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>A Fairytale Setting</h2>
                <div className={styles.textBlock}>
                    <p>
                        With its rolling hills and historic stone buildings, the Barossa Valley is a dream wedding location.
                        Complete the picture with a luxury vehicle from Auzzsi Chauffeur.
                        We ensure you arrive at the altar relaxed and in style.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Classic<br />Luxury</span>
                    </div>
                    <div className={styles.featureItem}>
                        <div className={styles.iconCircle}><Camera size={28} /></div>
                        <span className={styles.featureLabel}>Vineyard<br />Photos</span>
                    </div>
                </div>
            </section>
