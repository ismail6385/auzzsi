...
export default function BarossaCorporatePage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Do you service the Novotel Barossa?",
            answer: "Yes, we frequently transport conference delegates to the Novotel Barossa Valley Resort and other major venues."
        },
        {
            question: "Can we hire a car for a site inspection day?",
            answer: "Yes, our hourly chauffeur service is perfect for visiting multiple vineyards or production facilities in one day."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Professional transport for meetings.',
            passengers: 4,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Transport for marketing teams or delegations.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Corporate Transfers Barossa Valley"
                subtitle="Reliable transport for the wine industry and corporate events."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Business in the Barossa</h2>
                <div className={styles.textBlock}>
                    <p>
                        The Barossa Valley is a global business hub for the wine industry.
                        Auzzsi Chauffeur understands the needs of travelling executives and provides
                        discreet, professional service to ensure your schedule runs on time.
                        <br /><br />
                        From intimate board meetings to large conferences, we have the fleet to assist.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Industry<br />Experts</span>
                    </div>
                    <div className={styles.featureItem}>
