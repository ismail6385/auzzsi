...
export const metadata: Metadata = {
    title: "Wedding Cars Melbourne | Luxury Bridal Transport & Yarra Valley Weddings",
    description: "Make your special day unforgettable with Melbourne's premium chauffeur-driven wedding fleet. Elegant service for city, Yarra Valley, and Mornington Peninsula weddings.",
};
...
export default function MelbourneWeddingPage() {
    const faqs = [
        {
            ...
            answer: "We recommend booking as early as possible, typically 6-12 months in advance, especially if your wedding is during peak season (Spring/Autumn) or on a weekend. This ensures you get your preferred vehicle models and colors."
        },
        {
        ...
        },
        {
            ...
            answer: "Yes, generally there is a minimum hire period of 3 hours for wedding bookings. This allows ample time for pickups, the ceremony arrival, waiting during the service, and photo shoots afterwards."
        },
        {
            question: "Can We View The Cars Before Booking?",
            answer: "Absolutely. We encourage you to view our fleet in person. Please contact our team to schedule a private viewing appointment at our Melbourne showroom."
        },
        {
            question: "Do You Offer Transport For Wedding Guests?",
            answer: "Yes, in addition to the bridal party cars, we can arrange luxury people movers (Mercedes V-Class) or coaches to transport your guests between the ceremony and reception venues."
        }
    ];
    ...
    const vehicles = [
        ...
        },
        {
            ...
            desc: 'Luxury transport for family and guests. Ensure your loved ones arrive on time and together.',
            passengers: 7,
            luggage: 4,
            bags: 4,
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            {/* HERO SECTION */}
            <Hero
                title="Luxury Wedding Cars Melbourne"
                subtitle="Make your special day unforgettable with our premium chauffeur-driven wedding fleet. Elegant, timely, and perfect in every detail."
                showStats={false}
            />
            ...
            <section className={styles.contentSection}>
                ...
                <div className={styles.textBlock}>
                    <p>
                        Your wedding day is one of the most important days of your life, and every detail matters.
                        Auzzsi Chauffeur provides impeccable wedding car services across Melbourne and regional Victoria.
                        ...
                        to capture those perfect moments with the cars. We treat your day with the care and celebration it deserves.
                    </p>
                    ...
                    <p>
                        ...
                        for the entire bridal party and guests, we can tailor a package to suit your specific needs and budget.
