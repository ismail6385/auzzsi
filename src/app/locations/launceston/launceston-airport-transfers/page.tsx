...
export default function LauncestonAirportPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "How far is Launceston Airport from the city?",
            answer: "Launceston Airport (LST) is located about 15km south of the city. The trip usually takes 15-20 minutes."
        }
    ];
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroContent}>
                    <div className={styles.breadcrumb}>
                        ...
                        <Link href="/locations/launceston">Launceston</Link> <span>&gt;</span>
                        Airport Transfers
                    </div>
                    <h1 className={styles.heroTitle}>Launceston Airport Transfers</h1>
                    <p className={styles.heroSubtitle}>Professional transport in Northern Tasmania.</p>
            ...
            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Launceston Chauffeur Service</h2>
                <div className={styles.textBlock}>
                    <p>
                        Auzzsi Chauffeur offers reliable airport transfers at Launceston Airport (LST).
                        Perfect for accessing the city, Tamar Valley, or Cradle Mountain.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.fleetSection}>
                <h2 className={styles.sectionTitle} style={{ textAlign: 'center' }}>Our Launceston Fleet</h2>
            ...
            <section className={styles.contactSection}>
                ...
                <div className={styles.contactFormWrapper}>
                    <h2 className={styles.helpTitle}>Contact Launceston Support</h2>
