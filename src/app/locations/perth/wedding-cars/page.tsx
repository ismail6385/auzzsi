...
export const metadata: Metadata = {
    title: "Wedding Cars Perth | Luxury Bridal Transport & Swan Valley Weddings",
    description: "Make your special day unforgettable with Perth's premium chauffeur-driven wedding fleet. Elegant service for city, Swan Valley, and beach weddings.",
};
...
export default function PerthWeddingPage() {
    const faqs = [
        {
            ...
            answer: "In Perth, popular wedding dates in spring and autumn book out quickly. We recommend booking 6-12 months in advance to secure your preferred vehicle."
        },
        {
        ...
        },
        {
            ...
            answer: "Yes, we generally require a minimum hire period of 3 hours for weddings in the Perth Metro area. This ensures there is no rushing during your photos at Kings Park or Cottesloe Beach."
        },
        {
            question: "Can We View The Cars Before Booking?",
            answer: "Absolutely. We encourage you to inspect our fleet. Please contact our Perth team to schedule a private viewing appointment."
        },
        {
            question: "Do You Offer Transport For Wedding Guests?",
            answer: "Yes, we can arrange luxury Mercedes V-Class people movers or larger coaches to transport your guests between the ceremony and reception venues."
        }
    ];
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            {/* HERO SECTION */}
            <Hero
                title="Luxury Wedding Cars Perth"
                subtitle="Make your special day unforgettable with Perth's premier chauffeur-driven wedding fleet. Elegant, timely, and picture-perfect."
                showStats={false}
            />
            ...
            <section className={styles.contentSection}>
                ...
                <div className={styles.textBlock}>
                    <p>
                        ...
                        Auzzsi Chauffeur provides impeccable wedding car services across Perth, from excitement of the City to the romance of the Swan Valley.
                        ...
                        to capture those perfect moments against the backdrop of Kings Park or the Swan River. We treat your day with the care it deserves.
                    </p>
            ...
            <section className={styles.contactSection}>
                ...
                <ServiceContactForm
                    ...
                    subtitle={<>
                        Tell us about your Perth wedding and we will provide a custom package.
                        <br />
