...
export default function ToowoombaHourlyPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Do you do Carnival of Flowers tours?",
            answer: "Yes, September is our busiest month! We offer bespoke tours of the prize-winning gardens and public parks during the Carnival of Flowers."
        },
        {
            question: "Can we go to Spring Bluff?",
            answer: "Yes, the drive to the historic Spring Bluff Railway Station is a popular route for our hourly hire clients."
        }
    ];
    ...
    const vehicles = [
        ...
        },
        {
            ...
            desc: 'Perfect for garden tours with friends.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Hourly Chauffeur Toowoomba"
                subtitle="Explore the Garden City and Darling Downs in private luxury."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Discover the Darling Downs</h2>
                <div className={styles.textBlock}>
                    <p>
                        From the panoramic views at Picnic Point to the historic streets of the CBD,
                        Toowoomba is best explored by car. Hire a private chauffeur by the hour to create
                        your own itinerary.
                        <br /><br />
                        Visit local cafes, explore the gardens, or take a scenic drive through the countryside.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Hourly<br />Hire</span>
                    </div>
                    <div className={styles.featureItem}>
