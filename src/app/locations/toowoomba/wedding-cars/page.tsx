...
export default function ToowoombaWeddingPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Do you know Gabbinbar Homestead?",
            answer: "Yes, we are very familiar with Gabbinbar Homestead and other premier venues like Preston Peak Winery and Gip's Restaurant."
        },
        {
            question: "Can you transport guests from Brisbane?",
            answer: "Yes, we can arrange shuttles or private car transfers for guests travelling up from Brisbane for your wedding."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Timeless luxury for the bride and groom.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Luxury transport for the bridal party and guests.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Wedding Cars Toowoomba"
                subtitle="Elegant wedding car hire for your special day in the Garden City."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Garden City Weddings</h2>
                <div className={styles.textBlock}>
                    <p>
                        Toowoomba is famous for its stunning gardens and historic homesteads, making it a
                        premier wedding destination. Auzzsi Chauffeur adds to the magic with our fleet of
                        immaculate luxury vehicles.
                        <br /><br />
                        Enhance your photos and your experience with a professional chauffeur service.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Luxury<br />Style</span>
                    </div>
                    <div className={styles.featureItem}>
                        <div className={styles.iconCircle}><Camera size={28} /></div>
                        <span className={styles.featureLabel}>Stunning<br />Photos</span>
                    </div>
                </div>
            </section>
