...
export default function ToowoombaAirportPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "How long to Brisbane Airport?",
            answer: "The drive from Toowoomba to Brisbane Airport (BNE) typically takes 1 hour 45 minutes to 2 hours, depending on traffic conditions on the Warrego Highway."
        },
        {
            question: "Do you service Wellcamp Airport?",
            answer: "Yes, we provide reliable transfers to and from Toowoomba Wellcamp Airport (WTB) for all scheduled flights."
        },
        {
            question: "Is it a door-to-door service?",
            answer: "Yes, we pick you up from your home, hotel, or office in Toowoomba and drop you right at the terminal."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Comfortable highway touring.',
            passengers: 4,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Luxury Mercedes-Benz for the long drive.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Spacious for families and luggage.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Toowoomba Airport Transfers"
                subtitle="Seamless transfers to Toowoomba Wellcamp (WTB) and Brisbane Airport (BNE)."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Reliable Regional Transfers</h2>
                <div className={styles.textBlock}>
                    <p>
                        Whether you are catching a flight from the local Wellcamp Airport or heading down the range
                        to Brisbane International, Auzzsi Chauffeur ensures you get there safely and on time.
                        <br /><br />
                        Our fleet is perfect for the Warrego Highway journey, offering quiet comfort and safety features.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.fleetSection}>
                <h2 className={styles.sectionTitle} style={{ textAlign: 'center' }}>Toowoomba Fleet</h2>
