...
export default function ToowoombaCorporatePage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Do you service the Surat Basin?",
            answer: "Yes, we can arrange long-distance transfers for executives visiting energy and agriculture sites in the Surat Basin region."
        },
        {
            question: "Can I book a recurring transfer to Brisbane?",
            answer: "Absolutely. Many of our clients have weekly recurring bookings for meetings in Brisbane CBD."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Professional transport for regional business.',
            passengers: 4,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            name: 'Luxury SUV',
            desc: 'Robust comfort for regional roads.',
            passengers: 4,
            luggage: 4,
            bags: 3,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Corporate Transfers Toowoomba"
                subtitle="Executive chauffeur services for the Darling Downs business community."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Regional Business Excellence</h2>
                <div className={styles.textBlock}>
                    <p>
                        Toowoomba is a powerhouse of agriculture, education, and health.
                        Auzzsi Chauffeur provides the professional transport infrastructure that busy executives rely on.
                        <br /><br />
                        From CBD meetings to site visits across the Darling Downs, our chauffeurs deliver you refreshed and on time.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Mobile<br />Workspace</span>
                    </div>
                    <div className={styles.featureItem}>
