...
export default function CentralCoastAirportPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "How long is the trip to Sydney Airport?",
            answer: "Travel time from Gosford/Terrigal to Sydney Airport (SYD) is typically 90 minutes to 2 hours via the M1 Pacific Motorway and NorthConnex, depending on traffic."
        },
        {
            question: "Do you service Newcastle Airport?",
            answer: "Yes, we provide transfers north to Newcastle Airport (NTL), which is often a convenient option for domestic travel."
        },
        {
            question: "Is it a private service?",
            answer: "Yes, you book the entire vehicle. We do not do shared rides, so you travel directly to your destination without stopping for other passengers."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Smooth ride for the M1 journey.',
            passengers: 4,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Luxury Mercedes-Benz comfort.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            name: 'Luxury SUV',
            desc: 'Spacious Audi Q7, great for families.',
            passengers: 4,
            luggage: 4,
            bags: 3,
        ...
        },
        {
            ...
            desc: 'Ideal for families with lots of luggage.',
            passengers: 7,
            luggage: 6,
            bags: 6,
            image: '/tile-driver.png'
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Central Coast Airport Transfers"
                subtitle="Direct private transfers from the Central Coast to Sydney (SYD) and Newcastle (NTL) Airports."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>The Best Way to the Airport</h2>
                <div className={styles.textBlock}>
                    <p>
                        Forget the hassle of the train or navigating Sydney traffic yourself.
                        Auzzsi Chauffeur offers a premium door-to-door service from anywhere on the Central Coast
                        directly to the departure terminal.
                        <br /><br />
                        Whether living in Gosford, Terrigal, The Entrance, or Woy Woy, we have you covered.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    ...
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Private<br />Transfer</span>
                    </div>
                    <div className={styles.featureItem}>
