...
export default function CentralCoastCorporatePage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Do you offer regular commute services?",
            answer: "Yes, we can arrange regular pick-ups for executives commuting between the Central Coast and Sydney CBD."
        },
        {
            question: "Can I use travel time to work?",
            answer: "Absolutely. Our vehicles provide a quiet mobile office environment with privacy, allowing you to maximize productivity."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Efficient and comfortable for daily travel.',
            passengers: 4,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Mercedes-Benz luxury for important meetings.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Group transport for corporate teams.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Corporate Transfers Central Coast"
                subtitle="Reliable executive transport for Gosford, Wyong, and the entire Central Coast region."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Smart Business Travel</h2>
                <div className={styles.textBlock}>
                    <p>
                        Commuting from the Central Coast to Sydney doesn't have to be a chore.
                        Auzzsi Chauffeur transforms travel time into productive time with our premium corporate car service.
                        <br /><br />
                        We also service local businesses in Gosford, Erina, and Tuggerah Business Park.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    ...
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Consistent<br />Reliability</span>
                    </div>
                </div>
            </section>
