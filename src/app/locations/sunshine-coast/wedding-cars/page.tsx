...
export const metadata: Metadata = {
    title: "Wedding Cars Sunshine Coast | Luxury Bridal Transport",
    description: "Make your special day unforgettable with the Sunshine Coast's premier chauffeur-driven wedding fleet. Elegant service for beach and hinterland weddings.",
};

export default function SunshineCoastWeddingPage() {
    const faqs = [
        {
            question: "How Far In Advance Should I Book My Wedding Cars?",
            answer: "The Sunshine Coast is a very popular wedding destination. We highly recommend booking 12 months in advance, especially for spring and summer weddings in Noosa or Maleny."
        },
        {
            question: "Do You Travel To The Hinterland (Maleny/Montville)?",
            answer: "Yes, we frequently service weddings at Tiffany's, Spicers Clovelly, and The Old Dairy. Our vehicles are maintained to handle the range roads safely and comfortably."
        },
        {
            question: "Is There A Minimum Hire Time For Wedding Cars?",
            answer: "Yes, generally there is a minimum hire period of 3 hours for wedding bookings on the Sunshine Coast. This ensures a relaxed pace for photos at Point Perry or the Botanic Gardens."
        },
        {
            question: "Can You Provide Transport For Guests?",
            answer: "Absolutely. We can arrange Mercedes V-Class people movers or larger buses to transport guests from coastal accommodation to Hinterland venues and back."
        },
        {
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            {/* HERO SECTION */}
            <Hero
                title="Luxury Wedding Cars Sunshine Coast"
                subtitle="Make your special day unforgettable with the Coast's premier chauffeur-driven wedding fleet. Elegant service for beach and hinterland weddings."
                showStats={false}
            />

            {/* INTRO CONTENT */}
            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Coast & Country Romance</h2>
                <div className={styles.textBlock}>
                    <p>
                        From the pristine beaches of Noosa to the rolling green hills of Maleny, the Sunshine Coast offers stunning wedding backdrops.
                        ...
                        whether it's the Glass House Mountains view or a secluded beach cove. We treat your day with the care it deserves.
                    </p>
                    ...
                    <p>
                        ...
                        All packages include a uniformed chauffeur, ribbons, and refreshments - essential for warm Sunshine Coast days.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.contactSection}>
                ...
                <ServiceContactForm
                    ...
                    subtitle={<>
                        Tell us about your Sunshine Coast wedding and we will provide a custom package.
                        <br />
