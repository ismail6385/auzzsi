...
export default function SunshineCoastAirportPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "How far is Sunshine Coast Airport from Noosa?",
            answer: "Sunshine Coast Airport (MCY) in Maroochydore is about a 30-minute drive to Noosa Heads."
        },
        {
            question: "Do you service Brisbane Airport from the Sunshine Coast?",
            answer: "Yes, we regularly transfer passengers from Noosa, Maroochydore and Caloundra to Brisbane Airport (BNE)."
        }
    ];
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroContent}>
                    <div className={styles.breadcrumb}>
                        ...
                        <Link href="/locations/sunshine-coast">Sunshine Coast</Link> <span>&gt;</span>
                        Airport Transfers
                    </div>
                    <h1 className={styles.heroTitle}>Sunshine Coast Airport Transfers</h1>
                    <p className={styles.heroSubtitle}>Relaxing transfers to Noosa, Mooloolaba & Maroochydore.</p>
            ...
            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Sunshine Coast Luxury Transport</h2>
                <div className={styles.textBlock}>
                    <p>
                        Start your holiday the right way. Our chauffeurs will meet you at Sunshine Coast Airport (MCY) and
                        whisk you away to your resort in air-conditioned comfort. No waiting for taxis or shuttle buses.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.fleetSection}>
                <h2 className={styles.sectionTitle} style={{ textAlign: 'center' }}>Our Fleet</h2>
            ...
            <section className={styles.contactSection}>
                ...
                <div className={styles.contactFormWrapper}>
                    <h2 className={styles.helpTitle}>Contact Sunshine Coast Support</h2>
