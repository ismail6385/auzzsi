...
export const metadata: Metadata = {
    title: "Wedding Cars Byron Bay | Luxury Bridal Transport & Beach Weddings",
    description: "Make your special day unforgettable with Byron Bay's premier chauffeur-driven wedding fleet. Elegant service for beach, hinterland, and vineyard weddings.",
};

export default function ByronBayWeddingPage() {
    const faqs = [
        {
            question: "How Far In Advance Should I Book My Wedding Cars?",
            answer: "Byron Bay is a popular wedding destination. We recommend booking 9-12 months in advance, especially for peak wedding season (September to May) to secure your preferred luxury vehicles."
        },
        {
            question: "Do You Provide Wedding Ribbons And A Red Carpet?",
            answer: "Yes, our wedding packages include complimentary white satin ribbons for the bonnet and tulle for the rear shelf. We can also provide a red carpet for your arrival at the ceremony or reception venue."
        },
        {
            question: "Is There A Minimum Hire Time For Wedding Cars?",
            answer: "Yes, we generally require a minimum hire period of 3 hours for weddings in the Byron Bay region. This ensures there is no rushing during your photos at the beach, lighthouse, or hinterland locations."
        },
        {
            question: "Can We View The Cars Before Booking?",
            answer: "Absolutely. We encourage you to inspect our fleet. Please contact our Byron Bay team to schedule a private viewing appointment."
        },
        {
            question: "Do You Offer Transport For Wedding Guests?",
            answer: "Yes, we can arrange luxury Mercedes V-Class people movers or larger coaches to transport your guests between the ceremony and reception venues, ensuring everyone arrives on time and together."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'The ultimate wedding car. Spacious, elegant, and timeless. Perfect for beach and hinterland weddings.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            {/* HERO SECTION */}
            <Hero
                title="Luxury Wedding Cars Byron Bay"
                subtitle="Make your special day unforgettable with Byron Bay's premier chauffeur-driven wedding fleet. Elegant, timely, and picture-perfect."
                showStats={false}
            />
            ...
            <section className={styles.contentSection}>
                ...
                <div className={styles.textBlock}>
                    <p>
                        Your wedding day is a once-in-a-lifetime event, and every detail should be perfect.
                        Auzzsi Chauffeur provides impeccable wedding car services across Byron Bay and the Northern Rivers region.
                        ...
                        to capture those perfect moments against the backdrop of Byron's stunning beaches, lighthouse, or hinterland. We treat your day with the care it deserves.
                    </p>
            ...
            <section className={styles.contactSection}>
                ...
                <ServiceContactForm
                    ...
                    subtitle={<>
                        Tell us about your Byron Bay wedding and we will provide a custom package.
                        <br />
