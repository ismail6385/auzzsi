...
export default function NewcastleAirportPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "How far is Newcastle Airport from the CBD?",
            answer: "Newcastle Airport (NTL) in Williamtown is about a 25-30 minute drive from the Newcastle CBD."
        },
        {
            question: "Do you transfer to the Hunter Valley?",
            answer: "Yes, we provide transfers from Newcastle Airport to all areas of the Hunter Valley wine region."
        }
    ];
    ...
    const vehicles = [
        ...
        },
        {
            ...
            desc: 'Luxury van for groups and wine tours.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.heroContent}>
                    <div className={styles.breadcrumb}>
                        ...
                        <Link href="/locations/newcastle">Newcastle</Link> <span>&gt;</span>
                        Airport Transfers
                    </div>
                    <h1 className={styles.heroTitle}>Newcastle Airport Transfers</h1>
                    <p className={styles.heroSubtitle}>Connecting the Hunter and Newcastle to the world.</p>
            ...
            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Newcastle & Hunter Valley Transfers</h2>
                <div className={styles.textBlock}>
                    <p>
                        Auzzsi Chauffeur provides premium airport transfers at Newcastle Airport (NTL).
                        Whether you are heading into town for business or out to the vineyards for leisure, travel in comfort.
                    </p>
                </div>
            </section>
            ...
            <section className={styles.fleetSection}>
                <h2 className={styles.sectionTitle} style={{ textAlign: 'center' }}>Our Newcastle Fleet</h2>
            ...
            <section className={styles.contactSection}>
                ...
                <div className={styles.contactFormWrapper}>
                    <h2 className={styles.helpTitle}>Contact Newcastle Support</h2>
