...
export default function MorningtonHourlyPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "Can we create our own winery itinerary?",
            answer: "Absolutely. You can choose which wineries you want to visit, or our experienced drivers can recommend the best cellar doors for your taste."
        },
        {
            question: "Do you wait for us while we lunch?",
            answer: "Yes, with hourly hire, the vehicle and driver are yours for the day. We wait while you enjoy a long lunch or a soak at the Hot Springs."
        }
    ];
    ...
    const vehicles = [
        ...
        },
        {
            ...
            desc: 'Perfect for small group wine tours.',
            passengers: 7,
            luggage: 6,
            bags: 6,
        ...
        },
        {
            ...
            desc: 'The ultimate winery tour bus.',
            passengers: 11,
            luggage: 10,
            bags: 10,
            image: '/tile-driver.png'
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Hourly Chauffeur Mornington Peninsula"
                subtitle="Design your perfect day out on the Peninsula with a private driver."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Tours & Indulgence</h2>
                <div className={styles.textBlock}>
                    <p>
                        The Mornington Peninsula is best explored at a leisurely pace. Hire a chauffeur by the hour
                        and enjoy a private tour of the region's famous wineries, breweries, and distilleries.
                        <br /><br />
                        Or, take a relaxing drive to the Peninsula Hot Springs and let us worry about the drive home.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Hourly<br />Flexibility</span>
                    </div>
                    <div className={styles.featureItem}>
