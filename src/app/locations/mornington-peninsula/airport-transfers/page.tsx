...
export default function MorningtonAirportPage() {
    const [openFaq, setOpenFaq] = useState<number | null>(0);
    const toggleFaq = (index: number) => setOpenFaq(openFaq === index ? null : index);

    const faqs = [
        {
            question: "How long to Melbourne Airport?",
            answer: "From Sorrento/Portsea, allow 90 minutes to 2 hours. From Mornington/Mt Eliza, it's approximately 75-90 minutes via Peninsula Link and EastLink."
        },
        {
            question: "Do you cover Avalon Airport?",
            answer: "Yes, we provide transfers to Avalon Airport (AVV), although the journey can be longer depending on West Gate Bridge traffic."
        },
        {
            question: "Is toll road usage included?",
            answer: "Yes, all our fixed price quotes include necessary toll charges for EastLink and CityLink."
        }
    ];
    ...
    const vehicles = [
        {
            ...
            desc: 'Relaxing ride for the freeway journey.',
            passengers: 4,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Mercedes-Benz luxury class.',
            passengers: 3,
            luggage: 2,
            bags: 2,
            image: '/tile-audi.png'
        },
        {
            ...
            desc: 'Perfect for families and golf clubs.',
            passengers: 7,
            luggage: 6,
            bags: 6,
    ...
    return (
        <main className={styles.pageWrapper}>
            <Navbar />
            <Hero
                title="Mornington Peninsula Airport Transfers"
                subtitle="Reliable private transport to Melbourne (MEL) and Avalon (AVV) Airports."
                showStats={false}
            />

            <section className={styles.contentSection}>
                <h2 className={styles.sectionTitle}>Start Your Holiday Early</h2>
                <div className={styles.textBlock}>
                    <p>
                        Don't let the long drive up the Peninsula dampen your holiday spirit.
                        Auzzsi Chauffeur collects you from your door in Portsea, Sorrento, Flinders, or Mornington
                        and delivers you straight to the terminal.
                        <br /><br />
                        Enjoy a stress-free ride in a luxury vehicle with plenty of room for luggage and golf clubs.
                    </p>
                </div>
            </section>
            ...
            <section style={{ backgroundColor: '#f9fafb', padding: '2rem 0' }}>
                <div className={styles.featuresGrid}>
                    ...
                    <div className={styles.featureItem}>
                        ...
                        <span className={styles.featureLabel}>Golf<br />Friendly</span>
                    </div>
                    <div className={styles.featureItem}>
            ...
            <section className={styles.fleetSection}>
                <h2 className={styles.sectionTitle} style={{ textAlign: 'center' }}>Peninsula Fleet</h2>
